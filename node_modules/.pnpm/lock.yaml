...
importers:
  ...
  apps/desktop:
    dependencies:
      ...
      react-dropzone:
        specifier: ^19.1.1
        version: 19.1.1(@types/react@19.2.17)(react@19.2.7)
      react-hotkeys-hook:
        specifier: ^5.3.3
...
packages:
  ...
  react-dropzone@19.1.1:
    resolution: {integrity: sha512-zxuTwbyvP+FSdesiHafT/0UMTX/Ne1ri8XPTn7KM97ZinHKFy3N6KiKEGRiG28ibYV+nG6sHxoJlkVoDxIMHxQ==}
    engines: {node: '>= 20'}
    peerDependencies:
      '@types/react': '*'
      react: '>= 18'
...
snapshots:
  ...
  react-dropzone@19.1.1(@types/react@19.2.17)(react@19.2.7):
    dependencies:
      attr-accept: 2.2.5
      file-selector: 4.0.2
      react: 19.2.7
